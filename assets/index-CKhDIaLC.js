  ...
  try {
    const response = await fetch(
      `${"https://api.themoviedb.org/3"}/movie/popular?language=ko-KR&page=${page}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${"eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlM2ZmNTk1MDlmN2Y2N2U1NzAzMzZhMjUzODhlZjBlNSIsIm5iZiI6MTc0MjI4NTk1Ni41ODQsInN1YiI6IjY3ZDkyYzg0MzU3MmFmNWJjYzA4ODdkYiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Yv6fX48EgOCDq9fl6m1GDhYE7KfyDC7emlbYHhcO0us"}`
        }
      }
    );
    if (!response.ok) {
